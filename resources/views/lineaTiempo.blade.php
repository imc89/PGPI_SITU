  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 align="center" class="modal-title">LÍNEA TEMPORAL</h4>
      </div>
      <div class="modal-body" style="background-color: rgba(171, 184, 203, 0.70)">
       Has accedido a la LÍNEA TEMPORAL donde podrás ver tus hechos de forma cronológica y exportar a PDF.
       <br><br>
       <ul>
        <li>
          <br>
          -Podrás filtrar tus hechos por etiqueta, keyword o título de igual forma que en tu tablón de hechos. 
          <br>
        </li>

        <li>
          <br>
          -Para exportar la línea temporal basta con pulsar el botón de EXPORTAR A PDF.  
          <br>
        </li>
...
<script type="text/javascript">
  var phrases = [
  'Has accedido a la LÍNEA TEMPORAL donde podrás ver tus hechos de forma cronológica y exportar a PDF.Podrás filtrar tus hechos por etiqueta, Keyword o título de igual forma que en tu tablón de hechos.Para exportar la línea temporal basta con pulsar el botón de EXPORTAR A PDF.Los hechos irán apareciendo según bajes a lo largo de la línea.Podrás volver a la pantalla de inicio pulsando el icono de la universidad.'
  ];
