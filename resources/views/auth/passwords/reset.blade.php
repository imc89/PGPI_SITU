    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color: rgba(171, 184, 203, 0.70)">
       ...
       <ul>
        <li>
          <br>
          -Inserta tu Email y nuevo Password.  
          <br>
        </li>

        <li>
          <br>
          -Pulsa RESTABLECER PASSWORD para proceder al restablecimiento.  
          <br>
        </li>
      </ul>
...
<script type="text/javascript">
  var phrases = [
  'Has accedido a restablecer password.Inserta tu Email y nuevo Password.Pulsa,RESTABLECER password para proceder al restablecimiento.Podrás volver a la pantalla de inicio pulsando el icono de la universidad.'
  ];
